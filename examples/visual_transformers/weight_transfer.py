...
model_custom = VisualTransformer(**custom_config)
model_custom.eval()
...
for (n_o, p_o), (n_c, p_c) in zip(
    ...
    # we just take our custom parameter and we redefine it to be equal to the parameter of the official implementation 
    p_c.data[:] = p_o.data
